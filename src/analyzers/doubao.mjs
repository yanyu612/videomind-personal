...
2. 生成一级分类、二级分类和 2～5 个主题词，作为 Obsidian 双链节点。分类必须是可长期复用的稳定大类，严禁把具体人名、剧名、游戏名、视频标题或一句话主题当作分类。娱乐内容的 category_primary 固定写“休闲娱乐”，category_secondary 必须且只能从“电视剧、电影、游戏、明星、音乐、综艺、动漫、演出、日常娱乐、其他娱乐”中选择：美剧、英剧、韩剧等统一归“电视剧”；电子游戏统一归“游戏”；以歌手、演员、艺人、爱豆本人或其造型、经历、观点为核心的内容归“明星”。
